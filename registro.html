...
<li class="nav_items">
   ...
   <a href="secion.html" class="nav_links">INICIO DE SESION</a>
</li><li class="nav_items">
...
<img src="./IMAGENES/menu.svg"  class="nav_img">
       ...
       <section class="hero_container container">
               ...
               <p class="hero_paragraph">INICIO DE SESION
    ...
    <div class="contenedor">
        ...
        <form action="registro.php" method="POST">
            ...
            <label for="capitan">Capitán del Equipo:</label>
            <input type="text" id="capitan" required>
